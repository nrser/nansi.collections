...
class DebianArgs(Args):
    name = Arg(str, "esl-erlang")
    key_url = Arg(
        str,
        "https://packages.erlang-solutions.com" "/ubuntu/erlang_solutions.asc",
    )
    key_id = Arg(str, "2C8B586B1FC61E31C836D7B450B12719341540CB")
    repository_repo = Arg(
        str,
        "deb https://packages.erlang-solutions.com/ubuntu " "{release} contrib",
...
class ActionModule(ComposeAction):
    def os_family_debian(self):
        ...
        self.tasks.nansi.apt.ext(
            ...
            key_id=args.key_id,
            repository_repo=args.repository_repo,
        )
